    ...
    functions = [
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "status_range": {
                            ...
                            "minItems": 2,
                            "maxItems": 2,
                            "description": "List with two integers representing (min_status, max_status) for HTTP status codes"
                        },
                        "timezone_offset": {
                            "type": "string",
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "Count the number of Wednesdays between two given dates (inclusive).",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "start_date": {
                        ...
                        "day_of_week": {
                            "type": "string",
                            "enum": ["Wednesday"],
                            "description": "Day of the week to count (Only Wednesday is supported)"
                        }
                    },
                    "required": ["start_date", "end_date", "day_of_week"]
                },
            ...
            for tool_call in message["tool_calls"]:
                ...
                if function_name == "execute_command":
                    ...
                    answer = await transcribe_youtube_segment(
                        ...
                        start_time=function_args.get("start_time", 0),
                        end_time=function_args.get("end_time", 0),
                    )
                ...
                elif function_name == "count_wednesdays_in_range":
                    answer = await count_wednesdays(
                        start_date=function_args.get("start_date"),
                        end_date=function_args.get("end_date"),
                    )
